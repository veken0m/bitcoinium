...
public class Constants {
    ...
    public static final String PREFS_NAME_MINER = "com.veken0m.cavirtex.MinerWidgetProvider";
    public static final String PREFS_NAME_PRICE = "com.veken0m.cavirtex.WidgetProvider";
    public static final String PREFS_WALLET_ADDRESS = "com.veken0m.cavirtex.BalanceWidgetProvider";
