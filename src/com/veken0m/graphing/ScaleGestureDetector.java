...
public class ScaleGestureDetector {
	...
	public ScaleGestureDetector(Context context, SimpleOnScaleGestureListener simpleOnScaleGestureListener) {
		try {
			...
			Class<?> classRealScaleGestureDetector = Class.forName("com.veken0m.cavirtex.RealScaleGestureDetector");
			...
			// not available
			Log.w("com.veken0m.cavirtex.graphview", "*** WARNING *** No scaling available for graphs. Exception:");
			e.printStackTrace();
		}
	}
